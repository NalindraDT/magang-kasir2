...
class RestokController extends BaseController
{
    ...
    {
        // Data untuk tab "Manajemen Restok"
        ...
        // Data untuk tab "Manajemen Supplier" dan juga untuk dropdown
    ...
    public function return($id_restok)
    {
        ...
        $rules = [
            'jumlah_retur' => [
                'rules'  => 'required|integer|greater_than[0]|less_than_equal_to[' . $restok['jumlah_diterima'] . ']',
                'errors' => [
                    'greater_than'       => 'Jumlah retur harus lebih dari nol.',
                    'less_than_equal_to' => 'Jumlah retur tidak boleh melebihi jumlah barang yang sudah diterima.',
                ],
            ],
        ];
        ...
        $jumlahRetur = (int) $this->request->getPost('jumlah_retur');
