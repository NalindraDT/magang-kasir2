...
<main class="p-4 pt-20 sm:ml-16 flex flex-col items-center">
    ...
    <div class="p-4 rounded-lg min-h-screen max-w-full w-full">
        ...
        <a href="<?= base_url('admin/produk/tambah') ?>" class="inline-block w-fit text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Tambah Produk
        </a>
                    ...
                    <?php else: ?>
                        ...
                        <?php foreach ($produks as $produk): ?>
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <td class="px-6 py-4">
                                    <a href="<?= base_url('admin/produk/edit/' . $produk['id_produk']) ?>" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Edit</a>
                                    <a href="<?= base_url('admin/produk/hapus/' . $produk['id_produk']) ?>" class="font-medium text-red-600 dark:text-red-500 hover:underline ml-2" onclick="return confirm('Apakah Anda yakin ingin menghapus produk ini?')">Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    <?php endif; ?>
